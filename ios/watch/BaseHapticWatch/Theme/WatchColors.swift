...
enum WatchColors {
    static let gray950 = Color(red: 10/255, green: 10/255, blue: 11/255)
    static let gray900 = Color(red: 24/255, green: 24/255, blue: 27/255)
    static let gray800 = Color(red: 39/255, green: 39/255, blue: 42/255)
    static let gray700 = Color(red: 63/255, green: 63/255, blue: 70/255)
    static let gray600 = Color(red: 82/255, green: 82/255, blue: 91/255)
    static let gray500 = Color(red: 113/255, green: 113/255, blue: 122/255)
    static let gray400 = Color(red: 161/255, green: 161/255, blue: 170/255)
    static let gray300 = Color(red: 212/255, green: 212/255, blue: 216/255)
